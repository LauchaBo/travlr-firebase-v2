  ...
  try {
    ...
    userRef.get().then(userSnapshot => {
      if (!userSnapshot.exists) {
        ...
        let bookmarkRef = userRef.collection('bookmarks');
        bookmarkRef.add(bookmark).then(documentReference => {
...
exports.read = functions.https.onRequest((req, res) => {
  ...
  let documentRef = firestore.doc(`users/${userID}/bookmarks/${bookmarkID}`);
